 ...
 * @license Apache 2.0
 */
public class AppRedirection extends CordovaPlugin
{
    /**
        ...
        try {
            if (action.equals("open")) {
                if (args.length() == 1) {
                    ...
                    this.openDetailAppOnGooglePlay(appId);
     ...
     */
    private void openDetailAppOnGooglePlay(String appId) throws android.content.ActivityNotFoundException {
